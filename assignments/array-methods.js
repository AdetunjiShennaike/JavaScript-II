...
// Problem 1
// Everyones running number is the same as their id number and we have to email them their numbers so they know where to look for times after the race. grab all ids and correlated emails.
...
// Problem 2
// The director is drunk again, he now wants all first names lowercased and last names uppercased 
...
// Problem 3
// To make sure rollcall doesn't miss anyone by accident the name/call sheet would be better if it were in alphabetical order by last name.
